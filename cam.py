...
# [수정] 웹 브라우저 탭 제목을 Smart CAM Inspection System으로 변경했습니다.
...
# [수정] 메인 화면 대제목을 Smart CAM Inspection System으로 변경했습니다.
...
with col1:
    ...
    # 조경석(Cho Kyung-seok) 님 기본 우선 표시 유지
    inspector_val = st.selectbox("Inspector", ["Cho Kyung-seok", "Lee Wan-hee", "Kim Min-woo", "Lee Hong-gyu"])
    ...
    if st.button("📄 Generate PDF Report", type="primary"):
        ...
        pdf_filename = f"{formatted_date}_{clean_pn}_Label_Inspection.pdf"
        ...
        # [수정] PDF 리포트 내부 상단 타이틀도 지정 명칭으로 정정했습니다.
